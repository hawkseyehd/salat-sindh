...
// Dummy Education Resource data
const educationResources = [
  {
    id: 1,
    title: "ریاضی کے بنیادی تصورات", // Basic Concepts of Mathematics
    subject: "ریاضی", // Mathematics
    type: "لیکچر نوٹس", // Lecture Notes
    downloadUrl: "/placeholder.pdf",
  },
  {
    id: 2,
    title: "اردو قواعد و انشاء", // Urdu Grammar and Composition
    subject: "اردو", // Urdu
    type: "گائیڈ", // Guide
    downloadUrl: "/placeholder.pdf",
  },
  {
    id: 3,
    title: "کمپیوٹر سائنس کا تعارف", // Introduction to Computer Science
    subject: "کمپیوٹر سائنس", // Computer Science
    type: "کورس مواد", // Course Material
    downloadUrl: "/placeholder.pdf",
  },
  {
    id: 4,
    title: "تاریخ اسلام: اہم ادوار", // Islamic History: Key Periods
    subject: "تاریخ", // History
    type: "مطالعاتی مواد", // Study Material
    downloadUrl: "/placeholder.pdf",
  },
  {
    id: 5,
    title: "طبیعیات کے تجربات", // Physics Experiments
    subject: "طبیعیات", // Physics
    type: "عملی گائیڈ", // Practical Guide
    downloadUrl: "/placeholder.pdf",
  },
  {
    id: 6,
    title: "کیمیا کے بنیادی اصول", // Basic Principles of Chemistry
...
export default function EducationPage() {
  const navLinks = [
    ...
    { name: "تعلیم", href: "/education" }, // This page
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-xl font-medium text-blue-200 hover:text-red-400 transition-colors duration-300 relative group ${
                  link.href === "/education" ? "text-red-400" : ""
                }`}
                prefetch={false}
              >
                {link.name}
                <span
                  className={`absolute bottom-0 right-0 h-0.5 bg-red-400 transition-all duration-300 ${
                    link.href === "/education" ? "w-full" : "w-0 group-hover:w-full"
                  }`}
                ></span>
              </Link>
            ))}
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl text-red-400 mb-16">
            {"تعلیمی وسائل"} {/* Educational Resources */}
          </h1>
          <p className="mx-auto max-w-[900px] text-blue-200 md:text-xl lg:text-2xl leading-relaxed mb-16 opacity-90">
            {"یہاں آپ کو مختلف تعلیمی موضوعات پر مفید وسائل ملیں گے، جو صرف انتظامیہ کے ذریعے اپ لوڈ کیے گئے ہیں۔"}{" "}
            {/* Here you will find useful resources on various educational topics, uploaded only by administration. */}
          </p>
              ...
              >
                ...
                <CardContent className="p-6 pt-4 flex flex-col flex-grow justify-between text-right">
                  <p className="text-blue-200 mb-6 flex-grow leading-relaxed">
                    ...
                    {/* This material will be helpful in your education. */}
                  </p>
