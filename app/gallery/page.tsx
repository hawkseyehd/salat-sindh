...
// Dummy General Gallery data (all kinds of images)
const galleryImages = [
  {
    id: 1,
    title: "شہر کا نظارہ", // City View
    category: "شہری", // Urban
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 2,
    title: "پہاڑی منظر", // Mountain View
    category: "فطرت", // Nature
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 3,
    title: "جدید ٹیکنالوجی", // Modern Technology
    category: "ٹیکنالوجی", // Technology
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 4,
    title: "خوبصورت پھول", // Beautiful Flowers
    category: "فطرت", // Nature
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 5,
    title: "پرانی عمارتیں", // Old Buildings
    category: "تاریخی", // Historical
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
  {
    id: 6,
    title: "خوشگوار لمحے", // Happy Moments
    category: "لوگ", // People
    imageUrl: "/placeholder.svg?height=300&width=400",
  },
]
...
export default function GalleryPage() {
  const navLinks = [
    ...
    { name: "گیلری", href: "/gallery" }, // This page
            ...
            {navLinks.map((link) => (
              <Link
                ...
                className={`text-xl font-medium text-blue-200 hover:text-red-400 transition-colors duration-300 relative group ${
                  link.href === "/gallery" ? "text-red-400" : ""
                }`}
                prefetch={false}
              >
                {link.name}
                <span
                  className={`absolute bottom-0 right-0 h-0.5 bg-red-400 transition-all duration-300 ${
                    link.href === "/gallery" ? "w-full" : "w-0 group-hover:w-full"
                  }`}
                ></span>
              </Link>
            ))}
      ...
      <main className="flex-1 py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-8 text-center">
          <h1 className="text-5xl font-extrabold tracking-tight sm:text-6xl md:text-7xl text-red-400 mb-16">
            {"ہماری گیلری"} {/* Our Gallery */}
          </h1>
          <p className="mx-auto max-w-[900px] text-blue-200 md:text-xl lg:text-2xl leading-relaxed mb-16 opacity-90">
            {"یہاں آپ کو مختلف قسم کی تصاویر کا ایک وسیع مجموعہ ملے گا۔"}{" "}
            {/* Here you will find a wide collection of various types of images. */}
          </p>
          <div className="flex justify-center mb-10">
            <Link href="/gallery/create" prefetch={false}>
