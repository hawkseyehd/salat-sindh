...
export default function EditBlogPage({ params }: BlogEditPageProps) {
  ...
  const [state, formAction] = useActionState(updateBlogPost, null)
        ...
        <Card className="w-full max-w-3xl mx-auto bg-gray-800 rounded-2xl shadow-xl border border-blue-700/30">
          <CardHeader className="pb-6 text-center">
            <CardTitle className="text-4xl font-extrabold text-red-400">
              {"بلاگ پوسٹ میں ترمیم کریں"} {/* Edit Blog Post */}
            </CardTitle>
          </CardHeader>
          <CardContent className="p-6">
            <form action={formAction} className="space-y-6">
              ...
              <div>
                ...
                {blog.image && (
                  <div className="mt-2">
                    <p className="text-sm text-blue-300">Current image: {blog.image}</p>
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                {blog.thumbnail && (
                  <div className="mt-2">
                    <p className="text-sm text-blue-300">Current thumbnail: {blog.thumbnail}</p>
                  </div>
                )}
              </div>
